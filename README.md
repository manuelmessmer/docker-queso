This repository provides a docker image for QuESo. Please go to [QuESo](https://github.com/manuelmessmer/QuESo) for the actual repository. The original [LICENSE](https://github.com/manuelmessmer/QuESo/blob/main/LICENSE) also applies to the docker image.
